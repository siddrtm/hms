  ...
  <div id="site_title">
    ...
    <div id="f_content">
           ...
           <div id="main_column">
				...
				<div>
					<form action="adddoctor1.php" method="POST">
						 <p>doctor id<br/><input type="text" name="id" required/></p>
						 <br/>
						 <p>type<br/><input type="text" name="type" required/></p>
						 <br/>
						 <p>department<br/><input type="text" name="department" required/></p>
						 <br/>
