    ...
    <div id="f_content">
           ...
           <div id="main_column">
				...
				<div>
					...
					<form action="doctorprescribemedicine1.php" method="POST">
						<p>patient id<br/><input type="number" name="id" required/></p>
						<p>duration(days)<br/><input type="number" name="duration" required/></p>
						<p>dose<br/><input type="number" name="dose" required/></p>
						<p>medicine name<br/><input type="text" name="medicinename" required/></p>
