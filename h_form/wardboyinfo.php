           ...
           <div id="main_column">
				...
				<div>
					<?php 
						...
						$result = mysqli_query($con,"SELECT * FROM wardboy where wardboy.id=" . "'" . $_SESSION['id'] . "'");
						$result1 = mysqli_query($con,"SELECT * FROM staff where staff.id=" . "'" . $_SESSION['id'] . "'");
